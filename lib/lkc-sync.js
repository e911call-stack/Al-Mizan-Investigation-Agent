...
// -----------------------------------------------------------------------------
// Writes one ingested law article into the shared LKC tables
// (legal_documents / document_versions / legal_provisions / embeddings /
// legal_citations) — this is the one real place ingested law data lives.
//
//   - v1 is Jordan-only (see the LKC PRD). Only jurisdiction === 'jordan-civil'
//     is written — 'uae-mainland', 'uae-difc', 'egypt-civil', 'saudi' are
