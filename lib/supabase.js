...
// actor is an optional {id, email, name} from toFromUser(); recorded so the
// audit trail says which attorney did what.
export async function logAudit(supabase, caseId, agent, action, actor) {
